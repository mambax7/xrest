...
case 'dashboard':
    ...
    $indexAdmin->addInfoBoxLine(_XREST_AM_XREST_SUMANDTOTAL, '<label>' . _XREST_AM_XREST_TOTAL_FAILED_PLUGINS . '</label>', (int)XoopsCache::read('xrest_plugins_failed'), ((int)XoopsCache::read('xrest_plugins_failed') > 0?'Red':'Green'));
